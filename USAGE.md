...
5. [Использование по частям (Python API)](#5-использование-по-частям-python-api)
6. [Мультиспорт и сущности (страны/лиги/клубы)](#6-мультиспорт-и-сущности)
7. [Монетизация купона](#7-монетизация-купона)
8. [Подключение реальных данных через AI-коннектор](#8-подключение-реальных-данных-через-ai-коннектор)
9. [Тестирование и разработка](#9-тестирование-и-разработка)
...
- Для раздела 8 (AI-коннектор) — ключ любого провайдера спортивных данных
...
## 5. Использование по частям (Python API)
...
### 5.4 Калибровка вероятностей модели
...
### 5.5 Value detection и банкролл
...
### 5.6 Купон (несколько ставок в экспресс)
...
Это иллюстративный набор (5 стран, 3 вида спорта) — не полная база всех
клубов мира (см. раздел 8, как подключить реальные данные). Баскетбол и
теннис используют свои модели, но тот же движок value-betting/Kelly/coupon:
...
## 8. Подключение реальных данных через AI-коннектор
...
## 9. Тестирование и разработка

```bash
pytest tests/ -q     # 96 тестов, без реальных сетевых/AI вызовов (используются фейки)
